...
function addStyles(){
 ...
 .mapToolbar{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-bottom:10px}
 .mapToolbar .mapStat{font-size:12px;color:var(--muted);margin-right:auto}
 .detailDialog{max-width:560px}
 .detailHero{display:grid;gap:6px}.detailTitle{font-size:25px;font-weight:800}.detailTime{font-size:14px;color:var(--muted)}
 .detailBody{font-size:14px;line-height:1.55;color:#5d544c;white-space:pre-wrap}
 .detailGrid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.detailFact{padding:10px 12px;border:1px solid var(--line);border-radius:14px;background:#f6eee4}.detailFact small{display:block;color:var(--muted);font-size:10px;text-transform:uppercase;letter-spacing:.08em}.detailFact strong{display:block;margin-top:3px}
 .detailActions{display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap}
